<?php
  ...
  $sql = " insert into chef values ('".$chefId."','".$chefName."','".$chefPhone."','".$career."','".$chefsalary."','".$chefPassword."','".$chefTeam."')";
...
<html>
     <head>
         ...
         <title>HAHA Restaurant [신규 요리사 추가]</title>
     ...
     <body>
         ...
         <section>
           <div>
             <?php
             echo "<h1> HAHA 레스토랑 신규 요리사 추가 결과 </h1>";
             echo "<br><div id='im'> <img src='../img/bar1.PNG' width='80%' > </div><br>";
             echo "<div id=ma>";
             if($ret) {
                 echo "요리사의 정보가 성공적으로 추가되었습니다.";
             }
             else {
               echo "신규 요리사 추가 실패"."<br>";
