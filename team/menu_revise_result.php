<?php
  ...
  $sql = "update menu set menuNo='".$menuNo."', menuName='".$menuName."', price='".$price."', chefId='".$chefId."' where menuNo='".$menuNo."'";
...
<html>
  <head>
    ...
    <title>HAHA Restaurant [메뉴 정보 수정]</title>
