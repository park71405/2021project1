<?php
  ...
  $sql = "update customer set cusId='".$cusId."', cusName='".$cusName."', cusPhone='".$cusPhone."', cusPassword='".$cusPassword."' where cusId='".$cusId."'";
